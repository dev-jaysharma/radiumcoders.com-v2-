...
export default function Features() {
  return (
    <section className=" py-16 md:py-32 z-10  min-h-[90vh]">
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mt-4">
            At RadiumCoders, we offer a range of customizable solutions designed to meet your specific needs.
          </p>
        </div>
        {featuresCards()}
      </div>
  ...
  function featuresCards() {
    return <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
